...
export const STAFF_NAV: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/payment-plans", key: "nav.paymentPlans", any: ["arrears.view"] },
      { href: "/deposits", key: "nav.deposits", any: ["deposit.view"] },
      { href: "/reconciliation", key: "nav.reconciliation", any: ["payment.approve"] },
      { href: "/expenses", key: "nav.expenses", any: ["expense.view"] },
      { href: "/purchase-orders", key: "nav.purchaseOrders", any: ["expense.view"] },
    ],
  },
  {
